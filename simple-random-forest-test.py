...
class RandomForest:
    ...
    def preprocess_test_data(self, test_data, one_to_two):

        # split feature and label
        X_test_raw, y_test_raw = self.split_x_and_y(test_data, one_to_two)
    ...
    def preprocess_training_data(self, training_data, one_to_two):
        ...
        # split feature and label
        X_train_raw, y_train_raw = self.split_x_and_y(training_data, one_to_two)
